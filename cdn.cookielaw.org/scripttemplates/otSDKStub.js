var OneTrustStub = ((t) => {
  ...
  var i,
    ...
    s =
      ...
      (b.GENERIC = "GENERIC"),
      (b.LGPD = "LGPD"),
      (b.GENERIC_PROMPT = "GENERIC_PROMPT"),
      (b.CPRA = "CPRA"),
      (b.CDPA = "CDPA"),
      (b.DELAWARE = "DELAWARE"),
      (b.IOWA = "IOWA"),
      (b.NEBRASKA = "NEBRASKA"),
      (b.USNATIONAL = "USNATIONAL"),
      (b.CUSTOM = "CUSTOM"),
      (b.FLORIDA = "FLORIDA"),
      (b.COLORADO = "COLORADO"),
      (b.CONNECTICUT = "CTDPA"),
      ...
      (b.TEXAS = "TEXAS"),
      (b.OREGON = "OREGON"),
      (b.TENNESSEE = "TENNESSEE"),
      (b.NEWJERSEY = "NEWJERSEY"),
      (b.NEWHAMPSHIRE = "NEWHAMPSHIRE"),
      (b.UCPA = "UCPA"),
      (b.VIRGINIA = "VIRGINIA"),
      n.CPRA,
      n.CDPA,
      ...
      n.NEWHAMPSHIRE,
      n.UCPA,
      ((b = v = v || {}).Name = "OTGPPConsent"),
      (b[(b.ChunkSize = 4e3)] = "ChunkSize"),
      (b.ChunkCountParam = "GPPCookiesCount"),
      (b.gppSid = "gppSid"),
      ((n = a = a || {}).CPRA = "usca"),
      (n.CCPA = "usca"),
      (n.CDPA = "usva"),
      ...
      (b[(b.CCPA = 8)] = "CCPA"),
      (b[(b.CDPA = 9)] = "CDPA"),
      (b[(b.OREGON = 15)] = "OREGON"),
      (b[(b.USNATIONAL = 7)] = "USNATIONAL"),
      (b[(b.COLORADO = 10)] = "COLORADO"),
      (b[(b.FLORIDA = 13)] = "FLORIDA"),
      (b[(b.MONTANA = 14)] = "MONTANA"),
      (b[(b.TEXAS = 16)] = "TEXAS"),
      (b[(b.DELAWARE = 17)] = "DELAWARE"),
      (b[(b.IOWA = 18)] = "IOWA"),
      (b[(b.NEBRASKA = 19)] = "NEBRASKA"),
      (b[(b.NEWHAMPSHIRE = 20)] = "NEWHAMPSHIRE"),
      (b[(b.NEWJERSEY = 21)] = "NEWJERSEY"),
      (b[(b.TENNESSEE = 22)] = "TENNESSEE"),
      (b[(b.UCPA = 11)] = "UCPA"),
      (b[(b.VIRGINIA = 9)] = "VIRGINIA"),
      (b[(b.CTDPA = 12)] = "CTDPA"),
      (b[(b.IAB2V2 = 2)] = "IAB2V2"),
      "geo"),
    l = "otpreview",
    ...
    h =
      ...
      i.Months,
      i.Years,
      (m.prototype.camelize = function (t) {
        return (t = t.replace("--", ""))
          .split("-")
          .map(function (t, e) {
  ...
  var f = new (function () {
    ...
    A =
      ((y.initCSPTrustedType = function (t) {
  ...
  (S.prototype.initConsentSDK = function () {
    ...
    (S.prototype.captureShopify = function () {
      this.isShopify = p.stubScriptElement.hasAttribute(
    ...
    (S.prototype.getLocation = function (t) {
      if (
        ...
        ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) ||
          ...
          new h().implementThePolyfill()),
        A.checkAndAssignCspTrustedTypeEnabled(t) &&
          A.initCSPTrustedType(p.storageBaseURL),
        !t.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
          ...
          ((r.onload = function (t) {
            ...
            this && this.responseText
              ...
              o &&
                ...
                ((t = this.getResponseHeader("X-OneTrust-IsBot")),
                (u.isBotHeaderDomain = !!t && "true" === t.toLowerCase())),
    ...
    (S.prototype.getCookieNameSuffix = function () {
      return (this.scriptType === d || this.scriptType === c) &&
    ...
    (S.prototype.getStubAttrOrQueryParam = function (t) {
      ...
      return (
        i || ((i = e && e.getAttribute("src")), this.getStubQueryParam(i, t))
      );
    }),
            ...
            switch (t.label) {
              case 0:
                ...
                this.iabTypeAdded &&
                  ...
                  "IAB2V2" !== e.Type &&
                  this.removeTcf(),
                e.IsGPPEnabled ? f.init() : f.removeGppApi(),
                (i = p.stubScriptElement.cloneNode(!0)),
                (n = ""),
                (n = s.UseSDKRefactor
                  ? (p.isMigratedURL &&
                      (i.src =
                ...
                (this.charset = p.stubScriptElement.getAttribute("charset")),
                (this.isAmp = !!p.stubScriptElement.getAttribute("amp")),
                p.stubScriptElement.getAttribute("integrity"))
                  ? ((o =
                      s.CDNLocation +
                      "/scripttemplates/" +
                      s.Version +
